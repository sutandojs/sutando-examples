...
This example shows how to implement a **REST API** using [Hono](https://hono.dev/) and [Sutando](https://sutando.org). It uses a SQLite database file with some initial dummy data which you can find at [`./example.db`](./example.db).
...
```
cd sutando-examples/javascript/rest-hono
npm install
```
